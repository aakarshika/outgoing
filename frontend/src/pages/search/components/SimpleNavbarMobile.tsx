...
export function SimpleNavbarMobile({
  onCreateService,
}: {
  ...
  const menuGroups: MenuItem[][] = [
    ...
    [{ label: 'My Network', to: '/network', icon: 'solar:users-group-rounded-linear' }],
    [{ label: 'Settings', to: '/profile/settings-new', icon: 'solar:settings-linear' }],
    ...(isAuthenticated
      ? [[{ label: 'Logout', icon: 'solar:logout-2-linear', action: 'logout' as const, muted: true }]]
      : !isMobile
        ? [
          [
  ...
  return (
    <Box
      ...
      sx={{
        ...
        backgroundColor: isOrangePage ? '#D85A30' : ' white',
    ...
    >
      <Container
        maxWidth={false}
        sx={{ maxWidth: 1240, px: { xs: 1.5, sm: 3 }, py: 1.25, background: 'rgba(237, 232, 226, 0.9)' }}
      >
        <Box
          sx={{
            display: 'flex',
        ...
        >
            ...
            {hideSearchBar ? <>
              ...
              <Box
                sx={{
                  ...
                  '&:hover': {
                    backgroundColor: 'rgba(223, 216, 213, 0.9)',
                  },
                  minWidth: '40px',
                  height: '40px',
                  borderRadius: '10px',
                ...
                aria-label="Search"
              ><Icon icon="solar:magnifer-linear" className="h-4 w-4" /></Box></>}
          ...
          >
            ...
            <Box
              ...
              className="h-9 w-9 p-2 rounded-lg align-center justify-center flex items-center"
