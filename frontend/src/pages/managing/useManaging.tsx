...
export function isOnlineEventLocation(
...
export function formatLifecycleLabel(state: EventDetail['lifecycle_state'] | undefined) {
...
export function getChecklistTone(status: PlanningChecklistItem['status'] | undefined) {
  if (status === 'warn') {
    return {
      bg: '#FFF4E6',
      color: '#9A3412',
...
export function CompactManagingEventCard({
  item,
  onClick,
  nextChecklistItem,
}: {
...
export function ExpandableManagingEventCard({
  item,
  expanded,
  onToggle,
  nextChecklistItem,
...
export function EarningsBreakdownSection({
  title,
  hint,
  lines,
  accent,
...
export function EarningsEventRow({
  item,
  expanded,
  onToggle,
}: {
...
export function ServiceApplicationsRow({
  service,
  expanded,
  onToggle,
}: {
...
export function ServiceApplicationCard({
  application,
}: {
