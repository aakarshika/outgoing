    ...
    <div className="mx-auto max-w-3xl px-4 sm:px-6 py-8">
      ...
      {showForm && (
        <form
          ...
          className="rounded-xl border bg-card p-4 space-y-3 mb-6"
        >
          <input
            name="title"
            required
                  ...
                  <div className="mt-3 flex flex-wrap items-center gap-2">
                    ...
                    {(['goer', 'host', 'vendor'] as const).map((option) => (
                      <Button
                        ...
                        size="sm"
                        variant={
                          req.user_wishlist_as === option ? 'default' : 'outline'
                        }
                        onClick={() =>
                        ...
                        disabled={
                          wishlistMutation.isPending || removeWishlistMutation.isPending
                        }
                      >
                        {option === 'goer'
                          ? 'Goer'
