...
const MyServicesTab = lazy(() =>
  import('./tabs/MyServicesTab').then((m) => ({ default: m.MyServicesTab })),
);
const OpportunitiesTab = lazy(() =>
  import('./OpportunitiesTab').then((m) => ({ default: m.OpportunitiesTab })),
);
const ActivitiesTab = lazy(() =>
  import('./tabs/ActivitiesTab').then((m) => ({ default: m.ActivitiesTab })),
);
