...
export const PosterForEventCard = ({ imageUrl, title }: PosterProps) => {
    if (!imageUrl) return null;

    // "Crazy scissor" cut effect using polygon clip-path
    const scissorCutPath = 'polygon(0% 0%, 100% 0%, 100% 15%, 92% 25%, 100% 35%, 92% 45%, 100% 55%, 92% 65%, 100% 75%, 92% 85%, 100% 95%, 100% 100%, 0% 100%, 0% 95%, 8% 85%, 0% 75%, 8% 65%, 0% 55%, 8% 45%, 0% 35%, 8% 25%, 0% 15%)';
