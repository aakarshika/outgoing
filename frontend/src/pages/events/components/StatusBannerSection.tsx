...
export const StatusBannerSection = ({
    ...
    const showTimer = event.lifecycle_state === 'event_ready' || event.lifecycle_state === 'published';
                            ...
                            return (
                                <Box
                                    ...
                                    sx={{
                                        ...
                                        boxShadow: isCurrent ? '2px 2px 0px rgba(239, 68, 68, 0.2)' : '1px 1px 3px rgba(0,0,0,0.05)',
                                ...
                                >
                                    ...
                                    <Typography
                                        ...
                                        sx={{
                                            fontFamily: 'serif',
                                            fontSize: '0.65rem',
                                            color: isCurrent ? '#ef4444' : 'text.disabled',
                                            display: 'block',
                                            whiteSpace: 'nowrap',
                                            pointerEvents: 'none',
                                        }}
