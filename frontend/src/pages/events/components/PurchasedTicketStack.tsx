import { Box, Paper, Typography, Button as MuiButton, Grid } from '@mui/material';
            ...
            >
                ...
                <Box sx={{ display: 'flex' }}>
                    ...
                    >
                        <Typography
                            ...
                            sx={{
                                ...
                                alignItems: 'center',
                                justifyContent: 'center',
                                fontFamily: '"Permanent Marker"', mt: 1
                            }}
                        >
                    ...
                    >
                        <Typography
                            variant="h6"
                            sx={{ fontFamily: '"Permanent Marker"', fontSize: '1.2rem', color: 'black' }}
                        >
                            {type}
                        </Typography>
                        <Typography
