...
export const WhenAndWhereForm: React.FC<WhenAndWhereFormProps> = ({
  ...
  return (
    <EnclosingBox
      background="bg-[#ebf5ff] border border-blue-100"
      rotation={0.5}
      className="mt-2"
    >
                  ...
                  <div className="flex items-center gap-1.5 flex-wrap">
                    {[
                      ...
                      <button
                        ...
                        className={`px-2 py-0.5 rounded-none text-[10px] font-bold border transition-all ${
                  ...
                  <div className="mt-3 p-3 bg-white/50 border border-blue-100 shadow-sm relative">
                    ...
                    <div className="max-h-24 overflow-y-auto space-y-1 pr-1">
                      {previewDates.map((d: any, idx) => (
                        <div
                          key={idx}
                          className="text-[11px] text-blue-900 flex justify-between font-mono"
                        >
