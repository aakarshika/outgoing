...
export const TicketsAndCapacityForm: React.FC<TicketsAndCapacityFormProps> = ({
  ...
  return (
    <EnclosingBox
      background="bg-[#f0f9ff] border-2 border-dashed border-blue-200"
      rotation={-0.2}
    >
      <div className="mb-8">
        <ScrapbookHeading
        ...
        <div className="flex items-end gap-4 mb-8">
          ...
          <p className="text-[10px] text-gray-400 italic font-mono pb-2">
            ...
            <br />
            The last tier inherits remaining capacity.
          </p>
        </div>
                  ...
                  >
                    ...
                    <div className="flex-1 px-4 py-3 space-y-3">
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        ...
                        <div>
                          ...
                          <ScrapbookInput
                            ...
                            value={tier.admits}
                            onChange={(e) =>
                              handleTierChange(index, 'admits', e.target.value)
                            }
                            disabled={readonly}
                          />
                        </div>
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        <div>
                          <div
                            className="text-[9px] uppercase tracking-wider mb-1 flex items-center gap-1"
                            style={{ opacity: 0.7 }}
                          >
                            Capacity
