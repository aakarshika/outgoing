    ...
    <div className="space-y-4 rounded-xl border-2 border-blue-200 p-4 bg-white shadow-[2px_2px_0px_#bfdbfe] transition-all">
      <div className="flex items-center justify-between">
        ...
        <label className="flex items-center cursor-pointer">
          ...
          />
          <div
            className={`relative w-11 h-6 transition-colors border-2 shadow-[1px_1px_0px_#9ca3af] ${isRecurring ? 'bg-blue-400 border-blue-600' : 'bg-gray-200 border-gray-400'} ${readonly ? 'opacity-60 cursor-not-allowed' : ''}`}
          >
            <div
        ...
        <div className="pt-4 space-y-4 animate-in fade-in slide-in-from-top-2 border-t border-dashed border-blue-200">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 relative z-10">
              ...
              />
              <span className="text-sm font-bold text-blue-700">sessions</span>
            </div>
            <p className="text-xs text-gray-600 mt-1 font-mono">
              The rule:{' '}
              <strong className="text-blue-800">
                {buildRrule().replace('FREQ=', 'Repeats ').replace(';BYDAY=', ' on ')}
              </strong>
              .
            </p>
          </div>
