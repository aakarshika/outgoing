...
import { TicketTier } from './TicketsAndCapacityForm';
...
export const TicketsAndCapacityQuickForm: React.FC<TicketsAndCapacityQuickFormProps> = ({
    capacity,
    setCapacity,
    ticketTiers,
    setTicketTiers,
        ...
        <div className="space-y-5">
            ...
            >
                ...
                >
                    ...
                    <span className="text-white text-[9px] mt-1 opacity-70 text-center">× {tier.admits || '1'}</span>
                </div>
