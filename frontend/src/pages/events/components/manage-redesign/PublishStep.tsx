...
export function PublishStep({ event, readonly }: PublishStepProps) {
    ...
    const missingBasicInfoFields = [
        ...
        { key: 'location_address', label: 'Location Address', missing: !event.location_address },
        ...
        { key: 'ticket_tiers', label: 'Ticket Tiers', missing: !event.ticket_tiers || event.ticket_tiers.length === 0 },
