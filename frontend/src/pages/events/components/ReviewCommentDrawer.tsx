...
const CommentItem = ({
    ...
    return (
        <Box sx={{ mb: 2, ml: comment.parent ? 3 : 0, borderLeft: comment.parent ? '2px solid #333' : 'none', pl: comment.parent ? 2 : 0 }}>
            <Box sx={{ mb: 1 }}>
                <Hostname
            ...
            <Box sx={{ mt: 0.5, ml: 4.5 }}>
                ...
                <button
                    ...
                    style={{ fontFamily: '"Caveat", cursive', fontSize: '1rem', cursor: 'pointer', border: 'none', background: 'none' }}
                >
                    Reply
                </button>
...
export const ReviewCommentDrawer = ({ reviewId, commentsCount, isOpen, onClose }: ReviewCommentDrawerProps) => {
