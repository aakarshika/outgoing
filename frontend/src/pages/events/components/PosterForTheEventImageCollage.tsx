...
export const PosterForTheEventImageCollage = ({ imageUrl, title }: PosterProps) => {
    ...
    const scissorCutPath = 'polygon(0% 10%, 5% 0%, 15% 8%, 25% 0%, 35% 10%, 45% 0%, 55% 8%, 65% 0%, 75% 10%, 85% 0%, 95% 8%, 100% 0%, 100% 15%, 92% 25%, 100% 35%, 92% 45%, 100% 55%, 92% 65%, 100% 75%, 92% 85%, 100% 95%, 100% 100%, 85% 92%, 75% 100%, 65% 92%, 55% 100%, 45% 92%, 35% 100%, 25% 92%, 15% 100%, 5% 92%, 0% 100%, 8% 85%, 0% 75%, 8% 65%, 0% 55%, 8% 45%, 0% 35%, 8% 25%, 0% 15%)';
