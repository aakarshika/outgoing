            ...
            >
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                        ...
                        <div>
                            <label htmlFor="check_in_instructions" className="block text-sm font-medium mb-1">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3 bg-blue-50/50 p-4 rounded-xl border border-blue-100">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label htmlFor="start_time" className="block text-[10px] font-bold mb-1">
                                        Start
                                    </label>
                                    <input
                                        id="start_time"
                                ...
                                <div>
                                    <label htmlFor="end_time" className="block text-[10px] font-bold mb-1">
                                        End
                                    </label>
                                    <input
                                        id="end_time"
                ...
                <div className="flex items-center justify-between mb-6 border-b-2 border-gray-800 pb-2 border-dashed">
                    ...
                    <div className="flex rounded-full bg-gray-100 p-1 border border-gray-200">
                        <button
                            ...
                            className={`px-4 py-1 rounded-full text-xs font-bold transition-all ${locationMode === 'offline'
                        ...
                        <button
                            ...
                            className={`px-4 py-1 rounded-full text-xs font-bold transition-all ${locationMode === 'online'
                                ? 'bg-white shadow-[1px_1px_0px_#333] border-2 border-gray-800'
                                : 'text-gray-500 hover:text-gray-800'
                                }`}
                        >
