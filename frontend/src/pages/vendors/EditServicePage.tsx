...
import { useVendorService, useUpdateVendorService } from '@/features/vendors/hooks';
...
export default function EditServicePage() {
    ...
    const { register, handleSubmit, formState: { errors }, reset } = useForm<EditServiceFormData>();
    ...
    if (isLoading) {
        return (
            <Box sx={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', bgcolor: '#f4f1ea' }}>
                <Typography sx={{ fontFamily: '"Permanent Marker", cursive', fontSize: '2rem', animation: 'pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite' }}>
                    Loading...
                </Typography>
            </Box>
        );
    ...
    if (!serviceRes?.data) {
        return (
            <Box sx={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', bgcolor: '#f4f1ea' }}>
                <Typography sx={{ fontFamily: '"Permanent Marker", cursive', fontSize: '2rem' }}>
                    Service not found.
                </Typography>
            </Box>
        );
                        ...
                        <Paper elevation={2} sx={{
                            ...
                            <Box sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, gap: 4, alignItems: 'flex-start' }}>
                                ...
                                <Box sx={{ flex: 1 }}>
                                    ...
                                    />
                                    <Typography sx={{ mt: 2, fontSize: '0.75rem', fontFamily: '"Caveat", cursive', color: '#666', backgroundColor: '#fdfdfd', p: 1.5, borderLeft: '3px solid #2563eb' }}>
                                        Note: If you do not select a new image, your existing portfolio image will be kept.
                                    </Typography>
                                </Box>
                            </Box>
                        </Paper>
