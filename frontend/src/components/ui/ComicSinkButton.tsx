...
const ComicSinkButton = React.forwardRef<HTMLButtonElement, ComicSinkButtonProps>(
  (
    {
      className,
      variant,
        ...
        <span className="absolute inset-0">
          ...
          <span
            ...
            className={cn(
              ...
              'scale-[var(--shadow-rest-scale)] group-hover:scale-[var(--shadow-hover-scale)] origin-top-left',
