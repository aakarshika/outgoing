...
export const HostCard = ({ host, rating, tag = 'Vibe Architect', rotation: customRotation }: HostCardProps) => {
        ...
        <Box
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <Box sx={{
                    ...
                    <Media src={host.avatar || undefined} alt={host.username} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                </Box>
