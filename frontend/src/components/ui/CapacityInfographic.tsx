        ...
        <Box sx={{
            ...
            <Box sx={{ position: 'relative', zIndex: 1 }}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <Box>
                        <Typography sx={{ fontSize: '0.7rem', fontWeight: 'bold', color: '#666' }}>FILLED</Typography>
                        <Typography sx={{ fontFamily: '"Permanent Marker"', fontSize: '1.2rem' }}>{filled}</Typography>
                    </Box>
                    <Box sx={{ textAlign: 'right' }}>
                        <Typography sx={{ fontSize: '0.7rem', fontWeight: 'bold', color: '#666' }}>TOTAL</Typography>
                        <Typography sx={{ fontFamily: '"Permanent Marker"', fontSize: '1.2rem' }}>{capacity}</Typography>
                    </Box>
                </Box>
