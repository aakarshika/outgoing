    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            <div className="w-full max-w-md relative">
                ...
                <span className="absolute -top-6 left-4 text-2xl animate-bounce" style={{ animationDelay: '0s' }}>🎉</span>
                <span className="absolute -top-4 right-8 text-xl animate-bounce" style={{ animationDelay: '0.2s' }}>✨</span>
                <span className="absolute -bottom-4 left-10 text-xl animate-bounce" style={{ animationDelay: '0.4s' }}>🎊</span>
                <span className="absolute -bottom-6 right-6 text-2xl animate-bounce" style={{ animationDelay: '0.1s' }}>🥳</span>
                <span className="absolute top-1/2 -left-6 text-lg animate-bounce" style={{ animationDelay: '0.3s' }}>⭐</span>
                <span className="absolute top-1/3 -right-5 text-lg animate-bounce" style={{ animationDelay: '0.5s' }}>🎶</span>
                ...
                >
                    ...
                    <div className="flex flex-col items-center justify-center px-6 py-8 border-r-2 border-dashed border-gray-400 bg-[#fff4cc] min-w-[120px]">
                        <span
                            ...
                            style={{ writingMode: 'vertical-rl', textOrientation: 'mixed', fontFamily: '"Permanent Marker"' }}
                        >
                            ADMIT ONE
                        </span>
