...
import { Box, Typography, ThemeProvider, Paper, Modal, IconButton } from '@mui/material';
...
export function EditApplicationModal({ open, onClose, application }: EditApplicationModalProps) {
                ...
                >
                    ...
                    <IconButton
                        ...
                        sx={{
                            ...
                            right: 8,
                            color: '#666',
                            '&:hover': { color: '#000', transform: 'rotate(90deg)', bgcolor: 'transparent' },
                            transition: 'all 0.2s',
                        }}
                    >
                        <X className="h-5 w-5" />
                    ...
                    >
                        Update your proposal for <strong style={{ color: '#000' }}>{application.event_title}</strong>
                    </Typography>

                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 relative z-10">
                        {/* Select Service Component */}
                        <Box sx={{ p: 2, border: '1px dashed #ccc', bgcolor: '#fff', transform: 'rotate(0.5deg)' }}>
                        ...
                        {/* Message Component */}
                        <Box sx={{ p: 2, border: '1px dashed #ccc', bgcolor: '#fff', transform: 'rotate(0.2deg)' }}>
                            <label className="block text-xs font-bold tracking-wider text-gray-500 uppercase mb-2 font-mono">
                                Your Message *
                            </label>
                            <textarea
                        ...
                        <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 4 }}>
                            <button
                                ...
                                style={{ fontFamily: '"Permanent Marker"', fontSize: '1rem', transform: 'rotate(-1deg)' }}
                            >
