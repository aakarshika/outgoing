  ...
  return (
    <section className="py-4 group">
      ...
      <div className="relative">
        {/* Left Chevron */}
        <div
          className={`absolute left-0 top-0 bottom-0 z-10 w-12 sm:w-16 bg-gradient-to-r from-background to-transparent transition-opacity duration-300 pointer-events-none ${
        ...
        {/* Right Chevron */}
        <div
          className={`absolute right-0 top-0 bottom-0 z-10 w-12 sm:w-16 bg-gradient-to-l from-background to-transparent transition-opacity duration-300 pointer-events-none md:opacity-0 md:group-hover:opacity-100 ${
